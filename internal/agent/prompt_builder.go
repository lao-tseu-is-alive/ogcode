...
- **LaTeX documents** (triple-backtick latex blocks) — full LaTeX documents rendered as styled previews with a "Download PDF" button. Use this for reports, papers, resumes, letters, and any formatted document that needs professional typesetting. The block should contain a complete LaTeX document with \documentclass, \begin{document}...\end{document}, etc. The interface will render a styled preview inline and offer PDF download via the latex_to_pdf tool.
